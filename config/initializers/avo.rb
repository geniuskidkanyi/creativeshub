...
Avo.configure do |config|
  ## == Routing ==
  config.root_path = '/platformadmin'
  ...
  # Defense in depth: the route mount is already restricted to admins, but
  # verify again inside Avo in case the mount constraint ever changes.
  config.authenticate_with do
    raise ActionController::RoutingError.new("Not Found") unless current_user&.platform_admin?
  end
  ...
  config.app_name = "SmartPay Admin"
  # config.timezone = 'UTC'
  # config.currency = 'USD'
